      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>
              User reputation based on platform activity and behavior
            </CardDescription>
          </div>
          ...
          <TabsContent value="factors" className="space-y-4 pt-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <ScoreFactorCard
                ...
                impact={
                  factors.moderation.warnings > 0 ? "negative" : "neutral"
                }
  ...
  return (
    <div
      className={cn(
        ...
        isUnlocked ? "border-green-200 bg-green-50" : "opacity-70"
      )}
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
        ...
        {isUnlocked ? (
          ...
          <div className="text-xs bg-slate-100 text-slate-700 px-2 py-0.5 rounded-full">
            Locked
          </div>
        )}
      </div>
            ...
            <li key={i} className="flex items-start gap-2">
              <div
                className={cn(
                  ...
                  isUnlocked ? "bg-green-500" : "bg-slate-300"
                )}
              />
              <span>{benefit}</span>
            </li>
