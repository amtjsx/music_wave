...
class _SongDetailScreenState extends State<SongDetailScreen>
        ...
        children: [
          Expanded(
            child: ListView(
              ...
              children: [
                _buildFullPlayerWithVisualizer(currentSong, accentColor),
  ...
  Widget _buildFullPlayerWithVisualizer(Song song, Color accentColor) {
    return Stack(
      children: [
        ...
        SizedBox(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              if (index == currentSongIndex) return const SizedBox.shrink();
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: isReplying ? Colors.grey[800] : Colors.grey[900],
                          borderRadius: BorderRadius.circular(8),
                        ),
                        child: Column(
