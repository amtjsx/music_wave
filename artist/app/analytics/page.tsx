      ...
      >
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <TabsList className="grid w-full grid-cols-3 max-w-md">
            <TabsTrigger value="overview">{t("artist.overview", "Overview")}</TabsTrigger>
            <TabsTrigger value="audience">{t("artist.audience", "Audience")}</TabsTrigger>
            <TabsTrigger value="tracks">{t("artist.tracks", "Tracks")}</TabsTrigger>
          </TabsList>
